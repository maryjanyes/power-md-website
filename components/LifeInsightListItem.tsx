...
const LifeInsightListItem = ({ ...insight }) => {
    ...
    return (
        <li className="bg-gray-200 flex justify-between gap-x-6 py-5 px-4" key={insight.id}>
            <img className="h-12 w-12 flex-none rounded-full bg-gray-50" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
            <div className="p-2 flex-auto w-[50%]">
